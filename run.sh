...
CUDA_VISIBLE_DEVICES=6 python gs_simulation.py --model_path ./model/thuman4s00top/ --output_path outputs/output_thuman4s00top --config ./config/th4s00top_config.json --render_img --compile_video --output_ply
